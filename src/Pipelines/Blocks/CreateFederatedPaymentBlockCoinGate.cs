...
{
    [PipelineDisplayName("PaymentsBraintree.block.createfederatedpaymentCoinGate")]
    public class CreateFederatedPaymentBlockCoinGate : PipelineBlock<CartEmailArgument, CartEmailArgument, CommercePipelineExecutionContext>
    {
